...
from datautils import train_data_gen, train_test_label
...
if __name__ == "__main__":
    ...
    #### Initialize ####
    # checkpointfile = "checkpoint_2024-01-09_15-36-55"
    checkpointfile = None
    ...
    logger("Logger Initialized", right="-")
    ...
    logger("Data and Model Initialized", right="-")
